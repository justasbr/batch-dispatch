...
def prepare_tf(model):
    ...
    print(g.get_operations()[0:10])
    print(g.get_operations()[0].name)
    print([layer.name for layer in g.get_operations() if True or 'output' in layer.name.lower() or 'softmax' in layer.name.lower()])
